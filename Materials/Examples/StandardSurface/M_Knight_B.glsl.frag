...
uniform vec2 mtlxnormalmap6_scale = vec2(1.000000, 1.000000);
...
void main()
{
    ...
    mx_normalmap_vector2(normal4_out, mtlxnormalmap6_space, mtlxnormalmap6_scale, geomprop_Nworld_out1, geomprop_Tworld_out1, mtlxnormalmap6_out);
