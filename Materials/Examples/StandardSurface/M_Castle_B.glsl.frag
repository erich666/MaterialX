...
uniform vec2 mtlxnormalmap8_scale = vec2(1.000000, 1.000000);
...
void main()
{
    ...
    mx_normalmap_vector2(normal6_out, mtlxnormalmap8_space, mtlxnormalmap8_scale, geomprop_Nworld_out1, geomprop_Tworld_out1, mtlxnormalmap8_out);
